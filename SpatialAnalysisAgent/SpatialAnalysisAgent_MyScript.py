...
# script_directory = os.path.dirname(os.path.abspath(__file__))
# graphs_directory = os.path.join(script_directory, "graphs")
...
code, output = helper.execute_complete_program(code=code, try_cnt=5, task=task, model_name=model_name, documentation_str=documentation_str)
display(Code(code, language='python'))
