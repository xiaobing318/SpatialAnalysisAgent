...
G.add_node("network_data", node_type="data", 
           description="Loaded network data")
G.add_edge("load_network_data", "network_data")

# Step 2: Set Speed Limit as Edge Weight (Operation)
G.add_node("set_speed_limit_weight", node_type="operation", 
           description="Assign speed limits as edge weights for road segments in the network")
G.add_edge("network_data", "set_speed_limit_weight")

G.add_node("weighted_edges", node_type="data", 
           description="Road network with speed limits as edge weights")
